...
public class JobLoaderThread extends Thread {
    ...
    @Override
    public void run() {
        System.out.println("[Thread 2 - JobAdmitter] Started.");
        ...
        while (admittedCount < totalProcesses) {
            ...
            try {
                ...
                System.out.println("[Thread 2 - JobAdmitter] Process "
        ...
        System.out.println("[Thread 2 - JobAdmitter] All jobs admitted. "
        ...
        System.out.println("[Thread 2 - JobAdmitter] All processes completed. Terminating.");
    }
    ...
    public synchronized void notifyProcessCompleted(Process process) {
        ...
        System.out.println("[Thread 2 - JobAdmitter] Process "
            ...
            + completedProcesses + "/" + totalProcesses + " done)");
    }
